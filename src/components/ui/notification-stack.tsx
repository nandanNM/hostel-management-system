...
import { ArrowUpRight, BellSlash } from "@phosphor-icons/react"
import { motion, useReducedMotion, type Transition } from "motion/react"

import { EASE_OUT, SPRING_LAYOUT } from "@/lib/ease"
import { useHoverCapable } from "@/lib/hooks/use-hover-capable"
import { cn } from "@/lib/utils"
import { ActionSwapText } from "@/components/ui/action-swap"
...
export function NotificationStack({
  ...
  return (
    <motion.button
      ...
      onClick={handleClick}
      className={cn(
        "text-foreground relative z-10 block w-full max-w-[22rem] cursor-pointer rounded-3xl text-left outline-none",
