...
export function ComboboxContent({
  ...
  return createPortal(
    <motion.div
      ...
      className={cn(
        "border-border bg-background text-popover-foreground fixed z-[9999] w-(--combobox-trigger-width) overflow-hidden rounded-xl border will-change-[height,transform] outline-none",
        className
      )}
    >
      <motion.div
