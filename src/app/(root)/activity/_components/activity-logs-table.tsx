...
import { getMyActivityLogs, type MyActivityLogRow } from "../_lib/actions"
import { getColumns } from "./activity-logs-columns"

interface ActivityLogsTableProps {
  logsPromise: ReturnType<typeof getMyActivityLogs>
}
...
export function ActivityLogsTable({ logsPromise }: ActivityLogsTableProps) {
  ...
  const filterFields: DataTableFilterField<MyActivityLogRow>[] = [
