...
import type { MyActivityLogRow } from "../_lib/actions"
...
function LogDetailsPopover({ log }: { log: MyActivityLogRow }) {
    ...
    <Popover>
      ...
      <PopoverContent align="end" className="w-80 space-y-4 text-sm">
        ...
        <div>
          ...
          <p className="text-xs">
            {formatIST(log.timestamp, "dd MMM yyyy, HH:mm:ss")}
          </p>
        </div>
...
export function getColumns(): ColumnDef<MyActivityLogRow>[] {
  return [
    {
